            ...
            <div className="grid grid-cols-12">
              <div className="md:col-span-7 2xl:col-span-6 col-span-12">
                <div className="flex items-center justify-center p-1.5 sm:p-4 lg:p-6">
                  <div className="relative w-full md:pl-4 sm:pl-10 pl-5  md:pr-4 sm:pr-10 pr-5  border-2 border-solid border-red-500">
                    <div className="w-full relative border-2 border-solid border-red-500" style={{ height: "27vh", width:"27vh"  }}>
                      <video
                        autoPlay
                        playsInline
                        muted
              ...
              <div className="md:col-span-5 2xl:col-span-6 col-span-12 md:relative border-2 border-solid border-red-500">
