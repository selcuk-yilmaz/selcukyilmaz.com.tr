...
const items = [
  ...
  },
  {
    ...
    title: "Industrial Robot Interface",
    desc: "Web interface for the management of autonomously mobile robots for use in warehouses.",
    img: "/portfolioImages/robotInterface.png",
    link: "https://lama.dev",
  },
  {
    id: 3,
            ...
            {items.map((item) => (
              ...
              >
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <div className="relative w-80 h-56 md:w-96 md:h-64 lg:w-[500px] lg:h-[350px] xl:w-[900px] xl:h-[500px]">
